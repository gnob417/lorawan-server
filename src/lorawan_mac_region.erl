...
-export([join1_window/2, join2_window/2, rx1_window/2, rx2_window/2, rx1_rf/2, rx2_rf/2, rf_fixed/1, rf_beacon/2]).
...
rf_beacon(beacon, Region) ->
    %{Freq, DataRate, CodingRate} = regional_config(rx2_rf, Region),
    {ok, {Freq, DataRate, CodingRate}} = application:get_env(lorawan_server, beacon_rf),
    #txq{region=Region, freq=Freq, datr=DataRate, codr=CodingRate}.
